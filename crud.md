...
Ahora vamos a terminar de llenar nuestro controlador, debemos importar la clase Pastel a nuestro controlador para poder hacer uso del Modelo y asi trabajar con la base de datos, esto con la ayuda de [Eloquent](chapter9.md), como vimos durante el curso para crear un nuevo registro con Eloquent basta con definir una variable de un **new** Modelo, en este caso **Pastel**, segun se describe en el [capitulo 11](chapter11.md) los metodos responden a una ruta en especifico de la ruta resoure que agregamos en **routes.php**, para este caso vamos a definir cada uno de ellos en orden:
